...
{
    public partial class getempbyf : Form
    {
        GetEmpBy mf;
        getempbychmode cf;
        Controller cobj;
        ...
        private void Fn_Click(object sender, EventArgs e)
        {
            ...
            if (cf != null)
                 Dt = cobj.Get_Employee_by_fname(textBox1.Text);
            else if (mf!=null)
                 Dt = cobj.Get_Employee_by_fnamemn(textBox1.Text,id);
        ...
        private void getempbyf_Load(object sender, EventArgs e)
        {
